...
var orbits =[
			...
			{cx:0,cy:0,major:475,minor:475,Radius:4},
			{cx:0,cy:0,major:260,minor:260,Radius:4},
			{cx:0,cy:0,major:75,minor:75,Radius:4},
			{cx:0,cy:0,major:50,minor:50,Radius:4},
			{cx:0,cy:0,major:35,minor:35,Radius:4},
			{cx:0,cy:0,major:20,minor:20,Radius:4}


			]
// var orbits =[
			
// 			{cx:0,cy:0,major:475,minor:200,Radius:4},
// 			{cx:0,cy:0,major:260,minor:109.5,Radius:4},
// 			{cx:0,cy:0,major:75,minor:31.6,Radius:4},
// 			{cx:0,cy:0,major:50,minor:21,Radius:4},
// 			{cx:0,cy:0,major:35,minor:14.7,Radius:4},
// 			{cx:0,cy:0,major:20,minor:8.42,Radius:4}

// 			]

var planets =[  
				// {Radius:60,orbit:475,speed:0.05,x:-475,y:-200,href:"img/saturn.png"},
				// {Radius:28,orbit:260,speed:0.127,x:-260,y:-109.5,href:"img/jupiter.png"},
				// {Radius:15,orbit:75,speed:0.8,x:-75,y:-31.6,href:"img/mars.png"},
				// {Radius:15,orbit:50,speed:1.5,x:-50,y:-21,href:"img/earth.png"},
				// {Radius:15,orbit:35,speed:2.43,x:-35,y:-14.7,href:"img/venus.png"},
				// {Radius:15,orbit:20,speed:6.2,x:-20,y:-8.42,href:"img/mercury.png"}

				{Radius:60,orbit:475,speed:0.05,x:-475,y:-475,href:"img/saturn.png"},
				{Radius:28,orbit:260,speed:0.127,x:-260,y:-260,href:"img/jupiter.png"},
				{Radius:15,orbit:75,speed:0.8,x:-75,y:-75,href:"img/mars.png"},
				{Radius:15,orbit:50,speed:1.5,x:-50,y:-50,href:"img/earth.png"},
				{Radius:15,orbit:35,speed:2.43,x:-35,y:-35,href:"img/venus.png"},
				{Radius:15,orbit:20,speed:6.2,x:-20,y:-20,href:"img/mercury.png"}
...
var orbits = orbitsContainer.selectAll("g.orbit")
				...
				.attr("rx", function(d) {return d.major*2.8;})
				.attr("ry", function(d) {return d.minor*2.2;})
				.style("fill", "#3E5968")
...
function Draw1() {
	...
	d3.selectAll(".planet")
		...
		.attr("x", function(d) {
			var newRadius = -d.x*2.8 * Math.sin(counter*d.speed*Math.PI/180)-d.Radius/2;
			// console.log(countstep);
		...
		.attr("y", function(d) {
			var newRadius = -d.y*2.2* Math.cos(counter*d.speed*Math.PI/180)-d.Radius/2;
